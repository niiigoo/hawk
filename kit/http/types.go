...
// Method contains the distillation of information within a
// proto.Method that's useful for templating http transport.
type Method struct {
	Name string
...
// proto.OptionHttp that's useful for templating http transport.
type Binding struct {
